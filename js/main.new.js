...
controlButtons[2].addEventListener("click", () => {
  if (currentQuestion === 20) {
    controlButtons[2].disabled = true;
    controlButtons[0].disabled = false;
  } else if (currentQuestion === questions.length && currentQuestion < 21) {
  ...
  } else if (currentQuestion != questions.length && currentQuestion <= 20) {
    ++currentQuestion;
    clearScreen();
  ...
  // if (currentQuestion === 20) {
  //   controlButtons[3].disabled = true;
  // }
